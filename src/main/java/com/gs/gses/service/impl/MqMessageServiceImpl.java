...
import com.gs.gses.mapper.wms.MqMessageMapper;
import com.gs.gses.model.entity.MqMessage;
import com.gs.gses.model.enums.MqMessageSourceEnum;
import com.gs.gses.model.enums.MqMessageStatus;
import com.gs.gses.model.request.Sort;
import com.gs.gses.model.request.wms.MqMessageRequest;
...
import com.gs.gses.rabbitMQ.RabbitMQConfig;
import com.gs.gses.rabbitMQ.producer.DirectExchangeProducer;
...
import com.gs.gses.utility.MqSendUtil;
        ...
        if (e != null) {
            ...
            transactionTemplate.execute(transactionStatus -> {
                try {
                    ...
                    message.setStatus(com.gs.gses.model.enums.MqMessageStatus.CONSUME_FAIL.getValue());
