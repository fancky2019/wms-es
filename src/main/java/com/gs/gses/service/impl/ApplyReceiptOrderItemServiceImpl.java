...
import com.gs.gses.ftp.FtpConfig;
import com.gs.gses.ftp.FtpService;
import com.gs.gses.model.bo.wms.ExcelInspectionData;
import com.gs.gses.model.bo.wms.InspectionData;
import com.gs.gses.model.entity.ApplyReceiptOrder;
import com.gs.gses.model.entity.ApplyReceiptOrderItem;
...
import com.gs.gses.model.request.wms.ApplyReceiptOrderItemRequest;
...
import com.gs.gses.service.ApplyReceiptOrderItemService;
import com.gs.gses.mapper.wms.ApplyReceiptOrderItemMapper;
import com.gs.gses.service.ApplyReceiptOrderService;
import com.gs.gses.service.InspectionRecordService;
import com.gs.gses.service.MaterialService;
import com.gs.gses.utility.ExcelUpdater;
...
//                    FileUtils.copyInputStreamToFile(file.getInputStream(), existFile);
    ...
    private void updateInspectionQuantity(List<ExcelInspectionData> excelInspectionDataList) throws Exception {
        ...
        Map<String, MaterialResponse> materialCodeMap = materialResponseList.stream().collect(Collectors.toMap(com.gs.gses.model.response.wms.MaterialResponse::getXCode, p -> p));
...
//            }
    ...
    public void inspectionForm(MultipartFile[] productFiles,MultipartFile[] certificationFiles, ApplyReceiptOrderItemRequest applyReceiptOrderItemRequest) throws Exception {
        ...
        wrapper.eq(ApplyReceiptOrderItem::getApplyReceiptOrderId, applyReceiptOrder.getId());
        List<ApplyReceiptOrderItem> applyReceiptOrderItemList = baseMapper.selectList(wrapper);
