...
public interface ApplyReceiptOrderItemService extends IService<ApplyReceiptOrderItem> {
    ...
    void inspectionForm(MultipartFile[] files,MultipartFile[] files1,MultipartFile[] files2, ApplyReceiptOrderItemRequest applyReceiptOrderItemRequest) throws Exception;
