...
/**
 * 
 * @TableName ReceiptOrderItem
 */
@TableName(value ="ReceiptOrderItem")
@Data
public class ReceiptOrderItem implements Serializable {
    /**
     * 
     */
    @TableId(value = "Id")
     ...
     * 关联的收货单主表id
     */
    @TableField(value = "ReceiptOrderId")
     ...
     * 不合格数量
     */
    @TableField(value = "UnqualifiedQuantity")
