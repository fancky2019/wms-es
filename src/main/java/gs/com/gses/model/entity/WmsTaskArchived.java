...
/**
 * 
 * @TableName WmsTaskArchived
 */
@TableName(value ="WmsTaskArchived")
@Data
public class WmsTaskArchived implements Serializable {
    /**
     * 
     */
    @TableId(value = "Id")
     ...
     * 工单id
     */
    @TableField(value = "WorkOrderArchivedId")
    private Long workOrderArchivedId;
     ...
     * 原始创建时间戳13位
     */
    @TableField(value = "OldCreationTime")
    private Long oldCreationTime;

    /**
     * 原始修改时间戳13位
     */
    @TableField(value = "OldLastModificationTime")
    private Long oldLastModificationTime;
