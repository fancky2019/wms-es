...
/**
 * 
 * @TableName ShipOrderItemArchieved
 */
@TableName(value ="ShipOrderItemArchieved")
@Data
public class ShipOrderItemArchieved implements Serializable {
    /**
     * 
     */
    @TableId(value = "Id")
     ...
     * 关联的出库单主表id
     */
    @TableField(value = "ShipOrderArchievedId")
    private Long shipOrderArchievedId;
