...
/**
 * 
 * @TableName ApplyShipOrderItem
 */
@TableName(value ="ApplyShipOrderItem")
@Data
public class ApplyShipOrderItem implements Serializable {
    /**
     * 
     */
    @TableId(value = "Id")
     ...
     * 关联的申请单主表id
     */
    @TableField(value = "ApplyShipOrderId")
