...
/**
 * 
 * @TableName ApplyReceiptOrderItem
 */
@TableName(value ="ApplyReceiptOrderItem")
@Data
public class ApplyReceiptOrderItem {
    /**
     * 
     */
    @TableId(value = "Id")
     ...
     * 期望数量
     */
    @TableField(value = "ExpectedNumber")
    private BigDecimal expectedNumber;

    /**
     * 期望数量单位
     */
    @TableField(value = "ExpectedUnit")
    private String expectedUnit;

    /**
     * 收货数量
     */
    @TableField(value = "ReceivedNumber")
    private BigDecimal receivedNumber;

    /**
     * 收货数量单位
     */
    @TableField(value = "ReceivedUnit")
     ...
     * 可分配数量
     */
    @TableField(value = "WaitAllocateNumber")
